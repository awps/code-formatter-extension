...
chrome.tabs.onUpdated.addListener(function (tabId, changeInfo, tab) {
  if (changeInfo.status === 'complete' && /^http/.test(tab.url)) {
    fetch(tab.url).then(function (response) {
      ...
      var contentType = response.headers.get('Content-Type'); // console.log(contentType);
      ...
      }).then(function () {// console.log("INJECTED THE FOREGROUND SCRIPT.");
      })["catch"](function (err) {
      ...
      }).then(function () {// console.log("INJECTED THE FOREGROUND STYLE.");
      })["catch"](function (err) {
        return console.log(err);
      });
